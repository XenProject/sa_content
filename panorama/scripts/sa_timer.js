...
(function()
{
	...
	CustomNetTables.SubscribeNetTableListener("sa_player_table", OnTimerChanged)
	//GameEvents.Subscribe("lia_timer_start", StartTimer);
	GameEvents.Subscribe("sa_timer_stop", StopTimer);
	//GameEvents.Subscribe("lia_timer_time_left", NewEndTime);

	var data = CustomNetTables.GetTableValue("sa_player_table", "sa_timer")
